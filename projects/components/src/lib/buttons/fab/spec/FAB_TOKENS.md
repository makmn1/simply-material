...
| Name                       | Value                             |
|----------------------------|-----------------------------------|
| FAB large container height | `96dp`                            |
| FAB large container width  | `96dp`                            |
| FAB large icon size        | `36dp`                            |
| FAB large container shape  | `md.sys.shape.corner.extra-large` |

## FAB - Color - Tonal Primary
### Enabled
| Name                                     | Value                               |
|------------------------------------------|-------------------------------------|
| FAB tonal primary container color        | `md.sys.color.primary-container`    |
| FAB tonal primary container shadow color | `md.sys.color.shadow`               |
| FAB tonal primary container elevation    | `md.sys.elevation.level3`           |
| FAB tonal primary icon color             | `md.sys.color.on-primary-container` |
...
| Name                                       | Value                                 |
|--------------------------------------------|---------------------------------------|
| FAB tonal secondary container color        | `md.sys.color.secondary-container`    |
| FAB tonal secondary container shadow color | `md.sys.color.shadow`                 |
| FAB tonal secondary container elevation    | `md.sys.elevation.level3`             |
| FAB tonal secondary icon color             | `md.sys.color.on-secondary-container` |
...
| Name                                      | Value                                |
|-------------------------------------------|--------------------------------------|
| FAB tonal tertiary container color        | `md.sys.color.tertiary-container`    |
| FAB tonal tertiary container shadow color | `md.sys.color.shadow`                |
| FAB tonal tertiary container elevation    | `md.sys.elevation.level3`            |
| FAB tonal tertiary icon color             | `md.sys.color.on-tertiary-container` |
...
| Name                                 | Value                       |
|--------------------------------------|-----------------------------|
| FAB secondary container color        | `md.sys.color.secondary`    |
| FAB secondary container shadow color | `md.sys.color.shadow`       |
| FAB secondary container elevation    | `md.sys.elevation.level3`   |
...
| Name                                | Value                      |
|-------------------------------------|----------------------------|
| FAB tertiary container color        | `md.sys.color.tertiary`    |
| FAB tertiary container shadow color | `md.sys.color.shadow`      |
| FAB tertiary container elevation    | `md.sys.elevation.level3`  |
...
| Name                                     | Value                                    |
|------------------------------------------|------------------------------------------|
| FAB tertiary focused container elevation | `md.sys.elevation.level3`                |
| FAB tertiary focused state layer color   | `md.sys.color.on-tertiary`               |
| FAB tertiary focused state layer opacity | `md.sys.state.focus.state-layer-opacity` |
| FAB tertiary focused icon color          | `md.sys.color.on-tertiary`               |

### Pressed
| Name                                     | Value                                      |
|------------------------------------------|--------------------------------------------|
| FAB tertiary pressed container elevation | `md.sys.elevation.level3`                  |
| FAB tertiary pressed state layer color   | `md.sys.color.on-tertiary`                 |
| FAB tertiary pressed state layer opacity | `md.sys.state.pressed.state-layer-opacity` |
| FAB tertiary pressed icon color          | `md.sys.color.on-tertiary`                 |
